...
import { getConversation, toPublic as conversationToPublic } from '$lib/server/db/repo/conversations.js';
...
export const load: PageServerLoad = ({ locals, params }) => {
	...
	if (!conversation || conversation.kind !== 'chat') error(404, { message: 'Conversation not found' });
	return {
